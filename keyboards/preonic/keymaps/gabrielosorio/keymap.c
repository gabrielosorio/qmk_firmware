 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | RGBTG| Ctrl | Alt  | GUI  |Lower |    Space    | GUI  | Alt  | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  RGB_TOG, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RGUI, KC_RALT, KC_UP,   KC_RGHT
),
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSLS, KC_BSLS,
